...
function ArtisansSection() {
  ...
  return (
    <section className="h-full w-full xl:max-w-7xl xl:mx-auto pb-8">
      <div className="p-4 my-8 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-y-8 gap-2 md:gap-4 lg:gap-8">
        {newArtisans.map((artisan) => (
          <div
            key={artisan.coverImage}
            className="w-full rounded-t-xl space-y-2"
          >
            <img
